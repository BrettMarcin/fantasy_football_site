...
@Component
public class CheckIfUserIsPicking implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        Picks pick = draftService.getMostRecentPicksDraft(Integer.valueOf((String)pathVariables.get("draftId")));

        if(!pick.getUsername().equals(theUser.getUsername())) {
